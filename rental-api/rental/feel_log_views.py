...
from .mongo_serializers import Fleet_logSerializer
...
def feel_log_list_create(request):
    ...
    serializer = Fleet_logSerializer(data=request.data)
...
@permission_classes([IsAuthenticated])
def feel_log_detail(request, id: str):
    _id = oid_or_none(id)
    if _id is None:
    ...
    if request.method in ["PUT", "PATCH"]:
        serializer = Fleet_logSerializer(data=request.data, partial=(request.method == "PATCH"))
        serializer.is_valid(raise_exception=True)
